...
// if (currentURL.startsWith("http://localhost:")){
    var treejsonURL = 'data/greatdegeneration';// 'data/treedata.json', //'data/An apology for Raymond Sebond v1',     // the url of the external json file with tree data
