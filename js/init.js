...
/**global vars */
var treejsonURL = 'Phd Project1 20191221 egp.json';//'data/ULtraSound_20191221';// 'data/treedata.json', //'data/An apology for Raymond Sebond v1',     // the url of the external json file with tree data
